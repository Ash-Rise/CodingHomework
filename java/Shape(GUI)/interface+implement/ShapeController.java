...
public class ShapeController {
    ...
    private ArrayList<Shapable> shapableList = new ArrayList<>();
    ...
    void doSortAndTotal(ActionEvent event) {
        Collections.sort(shapableList, (a, b) -> Double.compare(b.getArea(), a.getArea()));

        areaLabel.setText("面积：");
        perimeterLabel.setText("周长：");
        double totalArea = 0;

        for (int i = 0; i < shapableList.size(); i++) {
            Shapable s = shapableList.get(i);
